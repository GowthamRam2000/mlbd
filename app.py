...
log_handler_file=logging.FileHandler("app_debug.log", mode='a') 
...
def render_header():
    try:
        ...
        st.subheader('A Demonstration of Big Data Concepts for MLBD subject by Gowtham Ram , Saravanan GS, Rajendra Panda')
